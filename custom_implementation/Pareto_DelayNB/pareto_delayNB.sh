for SPLIT_INDEX in {1..18}; do
    ...
    sshpass -p '1976@1976' ssh -o StrictHostKeyChecking=no new_username@10.100.117.1 \
        "source ~/miniconda3/etc/profile.d/conda.sh && conda activate torch121 && python /home/new_username/pareto/partition/delay/part2_mobile_200.py --host 10.100.117.4 --split-index $SPLIT_INDEX --output-dir '/home/new_username/pareto/partition/delay/mobilenetv2_G' --network-delay-ms 200" &
